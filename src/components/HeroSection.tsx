    ...
    <section className="h-[90vh] flex justify-center items-center">
      <div className="absolute top-0 h-[90vh] w-full rounded-b-4xl overflow-hidden">
        <img
          ...
          alt="photo"
          className="h-full w-full object-cover brightness-50 opacity-95"
        />
      </div>
      <div className="z-10 text-white text-3xl md:text-4xl text-center px-20 ">
        <div className="font-pt-serif">
          Start you journay <span className="text-lime-300">today.</span> Be a
          part of{" "}
          <span className="text-lime-300">a more substainable tomorrow.</span>
        </div>
